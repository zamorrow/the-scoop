...
function createComment(article, request) {
  const requestComment = request.body && request.body.comment;
  const userCheck = request.body && request.body.comment;
  const response = {};
  if (userCheck && requestComment && requestComment.articleId && requestComment.body && requestComment.username && database.users[requestComment.username] && database.articles[requestComment.articleId]){
      const comment = {
